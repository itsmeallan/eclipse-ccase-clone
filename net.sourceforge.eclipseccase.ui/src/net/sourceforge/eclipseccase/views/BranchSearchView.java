...
import net.sourceforge.eclipseccase.ui.actions.HistoryAction;
...
import net.sourceforge.eclipseccase.ui.actions.BranchSearchAction;
...
//				branchName.addModifyListener(this);
	...
	public void setProject(IProject project)
	{
		...
		for (int i = 0 ; i < projects.length ; i++)
		{
			...
			{
//				ClearCaseProvider provider = ClearCaseProvider.getClearCaseProvider(projects[i]);
//				if((provider != null) && (provider.isClearCaseElement(projects[i])))
//				{
...
//				}
			...
			else
			{
				...
				popupBranchList.setBounds(textBounds.x - branchName.getBounds().x-2, 
						textBounds.y + textBounds.height - branchName.getBounds().y-2, textBounds.width, 150);
				popupBranchList.setVisible(true);
			}
		}
	}
