 ...
 */
public abstract class FieldEditorPreferencePageWithCategories extends
    ...
    protected Control createContents(Composite parent) {
        ...
        for (int i = 0; i < categories.length; i++) {
            ...
            ((GridLayout) cartegoryParent.getLayout()).numColumns = ((GridLayout) getFieldEditorParent()
    ...
    private Composite createCategoryComposite(String category, Composite parent) {
        ...
        categoryComposite.addControlListener(new ControlAdapter() {
            public void controlResized(ControlEvent e) {
                Point preferredSize = categoryComposite.computeSize(
