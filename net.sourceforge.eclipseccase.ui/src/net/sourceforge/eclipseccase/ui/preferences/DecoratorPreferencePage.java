 ...
 */
public class DecoratorPreferencePage extends FieldEditorPreferencePageWithCategories implements IWorkbenchPreferencePage, IClearcaseUIPreferenceConstants {
	...
	private static final String[] CATEGORIES = new String[] { TEXT, IMAGES, GENERAL };
	...
	protected void createFieldEditors() {
		FieldEditor slave;
		// general
		masterDeep = new MasterBooleanFieldEditor(IClearcaseUIPreferenceConstants.GENERAL_DEEP_DECORATIONS, PreferenceMessages.getString("Decorator.General.DeepDecorations"), //$NON-NLS-1$
				getFieldEditorParent(GENERAL));
		addField(masterDeep);
		slave = new BooleanFieldEditor(GENERAL_DEEP_NEW, PreferenceMessages.getString("Decorator.General.DeepNew"), getFieldEditorParent(GENERAL)); //$NON-NLS-1$
		...
		addField(new BooleanFieldEditor(ICON_DECORATE_EDITED, PreferenceMessages.getString("Decorator.Images.DecorateEdited"), getFieldEditorParent(IMAGES))); //$NON-NLS-1$
		...
		addField(new BooleanFieldEditor(IClearcaseUIPreferenceConstants.TEXT_VIEW_DECORATION, PreferenceMessages.getString("Decorator.Text.ViewDecoration"), //$NON-NLS-1$
				getFieldEditorParent(TEXT)));

		addField(new BooleanFieldEditor(IClearcaseUIPreferenceConstants.TEXT_VERSION_DECORATION, PreferenceMessages.getString("Decorator.Text.VersionDecoration"), //$NON-NLS-1$
				getFieldEditorParent(TEXT)));

		masterPrefix = new MasterBooleanFieldEditor(IClearcaseUIPreferenceConstants.TEXT_PREFIX_DECORATION, PreferenceMessages.getString("Decorator.Text.PrefixDecoration"), //$NON-NLS-1$
				getFieldEditorParent(TEXT));

		addField(masterPrefix);

		slave = new StringFieldEditor(TEXT_PREFIX_DIRTY, PreferenceMessages.getString("Decorator.Text.PrefixDirty"), 4, getFieldEditorParent(TEXT)); //$NON-NLS-1$
		addField(slave);
		masterPrefix.addSlave(slave);

		slave = new StringFieldEditor(TEXT_PREFIX_HIJACKED, PreferenceMessages.getString("Decorator.Text.PrefixHijacked"), 4, getFieldEditorParent(TEXT)); //$NON-NLS-1$
		addField(slave);
		masterPrefix.addSlave(slave);

		slave = new StringFieldEditor(TEXT_PREFIX_NEW, PreferenceMessages.getString("Decorator.Text.PrefixNew"), 4, getFieldEditorParent(TEXT)); //$NON-NLS-1$
		addField(slave);
		masterPrefix.addSlave(slave);

		slave = new StringFieldEditor(TEXT_PREFIX_EDITED, PreferenceMessages.getString("Decorator.Text.PrefixEdited"), 4, //$NON-NLS-1$
				getFieldEditorParent(TEXT));
		addField(slave);
		masterPrefix.addSlave(slave);

		slave = new StringFieldEditor(TEXT_PREFIX_UNKNOWN, PreferenceMessages.getString("Decorator.Text.PrefixUnknown"), 4, //$NON-NLS-1$
				getFieldEditorParent(TEXT));
		addField(slave);
		masterPrefix.addSlave(slave);
	}
