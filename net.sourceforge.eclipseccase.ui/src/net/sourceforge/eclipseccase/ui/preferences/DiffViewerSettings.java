...
//import org.eclipse.team.svn.core.connector.SVNProperty;ExtDiffViewerPreferencePage
...
//			}
			...
			//get mine type for file.
			mimeType = URLConnection.guessContentTypeFromName(file.getFullPath().toString());
	...
	public static ResourceSpecificParameterKind getSpecificResourceKind(DiffViewerSettings diffSettings, IResource file, IProgressMonitor monitor) {
		ResourceSpecificParameterKind kind = null;				
...
//		String programPath = "kdiff3";
//		String parametersString = "/theirs:\"${theirs}\" /base:\"${base}\" /mine:\"${mine}\" /merged:\"${merged}\"";
//		String parametersString = "/base:\"${base}\" /mine:\"${mine}\" /merged:\"${merged}\"";
//		diffSettings.addResourceSpecificParameters(ResourceSpecificParameterKindEnum.FILE_EXTENSION, "cpp", new ExternalProgramParameters(programPath, parametersString));
