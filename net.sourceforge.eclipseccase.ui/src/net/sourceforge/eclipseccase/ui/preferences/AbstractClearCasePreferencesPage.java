...
import net.sourceforge.eclipseccase.ui.verifier.AbstractVerificationKeyListener;

import net.sourceforge.eclipseccase.ui.verifier.AbstractVerifier;
 ...
 */
public abstract class AbstractClearCasePreferencesPage extends PreferencePage implements IWorkbenchPreferencePage, IValidationManager {
    private VerificationKeyListener changeListener;
    
	public AbstractClearCasePreferencesPage() {
		super();
	...
	public boolean performOk() {
		...
		ClearCaseUI.getInstance().savePluginPreferences();
    ...
    protected class VerificationKeyListener extends AbstractVerificationKeyListener {
        ...
        public void hasError(String errorReason) {
        	AbstractClearCasePreferencesPage.this.setMessage(errorReason, IMessageProvider.ERROR);
			this.handleButtons();
        }

        public void hasWarning(String warningReason) {
        	AbstractClearCasePreferencesPage.this.setMessage(warningReason, IMessageProvider.WARNING);
			this.handleButtons();
        }

        public void hasNoError() {
        	AbstractClearCasePreferencesPage.this.setMessage(AbstractClearCasePreferencesPage.this.getTitle(), IMessageProvider.NONE);
			this.handleButtons();
        }

        protected void handleButtons() {
        	AbstractClearCasePreferencesPage.this.setValid(this.isFilledRight());
        }
