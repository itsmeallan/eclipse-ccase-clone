...
public class ClearcaseUIPreferences extends AbstractPreferenceInitializer {
    ...
    public static final String DECORATE_CHECKED_IN_ELEMENTS = _PREFIX_DECORATOR
            + "elements.checkedIn"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_CLEARCASE_ELEMENTS = _PREFIX_DECORATOR
            + "elements"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_EDITED_ELEMENTS = _PREFIX_DECORATOR
            + "elements.edited"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_ELEMENT_STATES_WITH_TEXT_PREFIX = _PREFIX_DECORATOR
            + "elements.textPrefix"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_ELEMENTS_WITH_VERSION_INFO = _PREFIX_DECORATOR
            + "elements.versionInfo"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_FOLDERS_CONTAINING_VIEW_PRIVATE_DIRTY = _PREFIX_DECORATOR
            + "folders.dirty.withViewPrivate"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_FOLDERS_DIRTY = _PREFIX_DECORATOR
            + "folders.dirty"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_HIJACKED_ELEMENTS = _PREFIX_DECORATOR
            + "elements.hijacked"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_PROJECTS_WITH_VIEW_INFO = _PREFIX_DECORATOR
            + "projects.viewInfo"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_UNKNOWN_ELEMENTS = _PREFIX_DECORATOR
            + "elements.unkown"; //$NON-NLS-1$

    /** decorator preference */
    public static final String DECORATE_VIEW_PRIVATE_ELEMENTS = _PREFIX_DECORATOR
            + "elements.viewPrivate"; //$NON-NLS-1$

    /** decorator preference */
    public static final String IMAGE_CLEARCASE_ELEMENTS_BACKGROUND_CUSTOM = _PREFIX_DECORATOR
            + "elements.image.background.custom"; //$NON-NLS-1$

    /** decorator preference */
    public static final String IMAGE_CLEARCASE_ELEMENTS_BACKGROUND = _PREFIX_DECORATOR
            + "elements.image.background"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_CHECKED_IN_ELEMENTS = _PREFIX_DECORATOR
            + "elements.textPrefix.checkedIn"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_DIRTY_ELEMENTS = _PREFIX_DECORATOR
            + "elements.textPrefix.dirty"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_EDITED_ELEMENTS = _PREFIX_DECORATOR
            + "elements.textPrefix.edited"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_HIJACKED_ELEMENTS = _PREFIX_DECORATOR
            + "elements.textPrefix.hijacked"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_UNKNOWN_ELEMENTS = _PREFIX_DECORATOR
            + ".elements.textPrefix.unknown"; //$NON-NLS-1$

    /** decorator preference */
    public static final String TEXT_PREFIX_VIEW_PRIVATE_ELEMENTS = _PREFIX_DECORATOR
            + "elements.textPrefix.viewPrivate"; //$NON-NLS-1$
    ...
    public static boolean decorateCheckedInElements() {
        return getPluginPreferences().getBoolean(
                ClearcaseUIPreferences.DECORATE_CHECKED_IN_ELEMENTS);
    }

    /**
     * Indicates if all ClearCase elements should be decorated with a
     * background icon.
     * 
     * @return <code>true</code> if enabled, <code>false</code> otherwise
     */
    ...
    public void initializeDefaultPreferences() {
        ...
        defaults.putBoolean(DECORATE_FOLDERS_CONTAINING_VIEW_PRIVATE_DIRTY,
                true);
