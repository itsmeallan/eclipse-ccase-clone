...
import net.sourceforge.eclipseccase.ui.verifier.ResourcePathVerifier;
...
public class PathSelectionComposite extends Composite {
	...
	protected void createControls() {
		...
		browseButton.setText(Messages.getString("Button_Browse"));
		data = new GridData();
		data.widthHint = SwtHelper.computeButtonWidth(browseButton);
