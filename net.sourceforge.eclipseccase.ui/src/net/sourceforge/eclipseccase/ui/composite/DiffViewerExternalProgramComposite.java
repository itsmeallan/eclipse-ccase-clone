...
public class DiffViewerExternalProgramComposite extends Composite {
	...
	protected void createControls() {
		...
		this.pathComposite = new PathSelectionComposite(
				Messages.getString("DiffViewerExternalProgramComposite_Path_LabelName"),
				Messages.getString("DiffViewerExternalProgramComposite_Path_FieldName"),
				Messages.getString("DiffViewerExternalProgramComposite_Path_BrowseDialogTitle"),
			null,
			false,
			parametersGroup,
		...
		data.heightHint = SwtHelper.convertHeightInCharsToPixels(this.parametersText, 5);
		...
		data.widthHint = SwtHelper.computeButtonWidth(variablesButton);
