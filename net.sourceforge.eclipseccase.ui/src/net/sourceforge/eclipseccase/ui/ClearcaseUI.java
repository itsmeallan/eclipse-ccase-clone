...
public class ClearcaseUI extends AbstractUIPlugin {
    ...
    /** debug option */
    private static final String DEBUG_OPTION_DECORATION = ClearcaseUI.PLUGIN_ID
            + "/debug/decoration"; //$NON-NLS-1$

    /** debug option */
    private static final String DEBUG_OPTION_PLUGIN = ClearcaseUI.PLUGIN_ID
    ...
    public void start(BundleContext context) throws Exception {
        ...
        ClearcasePlugin.getInstance().setClearcaseModificationHandler(
                new ClearcaseUIModificationHandler());
    ...
    /**
     * Returns the preference value for <code>TEXT_PREFIX_VIEW_PRIVATE_ELEMENTS</code>.
     * 
    ...
    /**
     * Returns the preference value for <code>TEXT_PREFIX_UNKNOWN_ELEMENTS</code>.
     * 
     * @return the preference value
     */
    ...
    /**
     * Returns the preference value for <code>TEXT_PREFIX_HIJACKED_ELEMENTS</code>.
     * 
     * @return the preference value
     */
