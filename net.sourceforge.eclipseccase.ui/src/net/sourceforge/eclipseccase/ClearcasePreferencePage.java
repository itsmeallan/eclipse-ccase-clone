...
/**
 * ClearcasePreferencePage.
 */
public class ClearcasePreferencePage extends FieldEditorPreferencePage
        implements IWorkbenchPreferencePage
{
            ...
            IPersistentPreferenceStore
    {
        ...
        /**
         * Identity list of old listeners (element type: <code>org.eclipse.jface.util.IPropertyChangeListener</code>).
         */
        private ListenerList listeners = new ListenerList();

        /**
         * Indicates whether property change events should be suppressed (used
         * in implementation of <code>putValue</code>). Initially and
                ...
                Object newValue)
        {
            ...
            Platform.run(new SafeRunnable(JFaceResources
                    .getString("PreferenceStore.changeError"))
            { //$NON-NLS-1$
    ...
    {
        addField(new BooleanFieldEditor(IPreferenceConstants.ADD_COMMENT,
                "Prompt for comment when adding to clearcase",
                getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.CHECKIN_COMMENT,
                "Prompt for comment on checkin", getFieldEditorParent()));
        ...
        addField(new BooleanFieldEditor(IPreferenceConstants.CHECKOUT_COMMENT,
                "Prompt for comment on checkout", getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.RESERVED_CHECKOUT,
                "Reserved Checkouts", getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.CHECKOUT_ON_EDIT,
                "Automatically checkout file when edited",
                getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.REFACTOR_ADDS_DIR,
                "Automatically add dest dir to clearcase when refactoring",
                getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.USE_CLEARTOOL,
                "Use the cleartool executable for clearcase operations",
                getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.PERSIST_STATE,
                "Persist element state cache across sessions",
                getFieldEditorParent()));

        addField(new BooleanFieldEditor(IPreferenceConstants.REFRESH_ON_CHANGE,
        ...
        addField(new BooleanFieldEditor(
                ...
                "Enable multi-line comments", getFieldEditorParent()));
    }
